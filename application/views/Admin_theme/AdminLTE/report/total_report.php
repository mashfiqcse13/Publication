                            ...
                            <table  class="table table-bordered report">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <th></th>
                                        <th class="taka_formate"><?php echo $SaleCollectionCash; //$cash_collection = $sale_info->sale_against_cash_collection - $remaining_due_collection_by_cash; ?></th>  
                                    </tr>
                                    <tr>
                                        <td width="50%">Bank Collection</td>
                                        <th></th>
                                        <th class="taka_formate"><?php echo $SaleCollectionBank;//$bank_collection = $sale_info->sale_against_bank_collection - $remaining_due_collection_by_bank; ?></th>  
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>                     
                                        <td width="50%">Due</td>
                                        <th></th>
                                        <th class="taka_formate"><?php echo  $sale_info->total_sale - ($SaleCollectionBank + $SaleCollectionCash + $sale_info->sale_against_advance_deduction +$sale_info->sale_against_due_deduction_by_old_book_sell ) //$sale_info->sale_against_due + $remaining_due_collection; ?></th>  
                                    </tr>
                                ...
                                <tr>
                                    <td width="50%">
                                        <table class="table">
                                            ...
                                            <tr>
                                                <td>Cash to Owner</td>
                                                <th style="text-align: center">(-)<span class="taka_formate"><?php echo $total_cash_2_owner ?></span></th>
                                            </tr>
                                            <tr>

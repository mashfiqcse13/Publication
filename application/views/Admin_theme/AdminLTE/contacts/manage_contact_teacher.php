...
//        distName.innerHTML = "";
    ...
    $("#id_contact_teacher_sucject_input_box").after(' &nbsp; <?php echo anchor('contacts/teacher_sucject', '<i class="fa fa-plus-circle"></i>  <span>Add / edit Subjects</span>',array("class"=>"btn btn-sm btn-default")); ?>');

...
//                                echo form_open('', $attributes)
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                <p class="text-right">Report Date: <?php echo date('d-M-Y') ?></p>
...
<!--                                            $attributes1 = array(
                    ...
                    <td><?php echo " " . $memo_header_details['issue_date'] ?></td>
                                    ...
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right taka_formate"><?=$row['regular_price']?></td>
                                            <td class="text-right taka_formate"><?=$row['sale_price']?><input type="hidden" name="price[]" class="form-control"  value="<?=$row['sale_price']?>"></td>
                                            <td>
    ...
    <div class="report-logo-for-print container memo_print_option custom_memo" >

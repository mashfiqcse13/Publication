...
class Memo extends CI_Model{
	...
	function memogenerat($id){
		...
		$query = $this->db->query("SELECT pub_books.name as book_name,quantity,price,total,discount,pub_contacts.name as party_name,pub_contacts.district as party_district,pub_contacts.address as party_address,pub_contacts.phone as party_phone FROM `pub_memos_selected_books` 

...
class Payment_log extends CI_Controller{
    ...
    function index(){
        ...
        $crud->set_subject('customer_payment');
        $crud->set_relation('id_customer','customer','name');
        $crud->set_relation('id_customer_due_payment_register','customer_due_payment_register','tatal_paid_amount');
        $crud->set_relation('id_payment_method','payment_method','name_payment_method');
        $crud->columns('id_customer','id_total_sales','id_payment_method','paid_amount','id_customer_due_payment_register','payment_date');
        $crud->display_as('id_customer','Customer Name');
        $crud->display_as('id_total_sales','Memo No');
        $crud->display_as('id_customer_due_payment_register','Due payment');
        $crud->display_as('id_payment_method','Payment Method');
        $crud->display_as('paid_amount','Amount');
